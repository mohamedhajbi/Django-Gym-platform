...
class TrainerNotificationsAdmin(admin.ModelAdmin):
	list_display=('notif_msg',)
admin.site.register(models.TrainerNotifications,TrainerNotificationsAdmin)

class TrainerNotificationsStatusAdmin(admin.ModelAdmin):
	list_display=('notif',)
admin.site.register(models.NotifTrainerStatus,TrainerNotificationsStatusAdmin)



class TrainerTasktAdmin(admin.ModelAdmin):
	list_display=('trainer_ts','user_ts')
admin.site.register(models.TrainerTask,TrainerTasktAdmin)
